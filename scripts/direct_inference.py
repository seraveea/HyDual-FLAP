...
if __name__ == "__main__":
    ...
    #  "output/chn/chn_rag_chatqa_0.parquet",
    #  "output/chn/chn_rag_chatqa_1.parquet",
    #  "output/chn/chn_rag_chatqa_2.parquet",
    #  "output/chn/chn_rag_ds_0.parquet",
    #  "output/chn/chn_rag_ds_1.parquet",
    #  "output/chn/chn_rag_ds_2.parquet",
    #  "output/eng/rag_ds_0.parquet",
    #  "output/eng/rag_ds_1.parquet",
    # "output/eng/rag_ds_2.parquet",
    # "output/eng/rag_llama3_0.parquet",
    # "output/eng/rag_llama3_1.parquet",
    # "output/eng/rag_llama3_2.parquet",
    ]
    result_list = []
